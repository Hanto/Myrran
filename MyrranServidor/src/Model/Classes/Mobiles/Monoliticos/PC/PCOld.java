package Model.Classes.Mobiles.Monoliticos.PC;// Created by Hanto on 07/04/2014.
...
public class PCOld extends PCOldNotificador implements PropertyChangeListener, PCI, Debuffeable
{
    ...
    @Override public void setActualCastingTime(float castingTime)           { actualCastingTime = castingTime; }
    ...
    public PCOld(int connectionID, Cuerpo cuerpo)
    {
